...
function Signin({setIsSignin,isSignIn}) {
  ...
  return (
    <div className='flex flex-col items-center justify-center h-screen'>
     <h1 className='text-2xl text-teal-500 w-full text-center mb-[2rem]'>Log in to your account.</h1>
        ...
        <p className='cursor-pointer'>Create an account <span  onClick={() => setIsSignin(false)} className='hover:text-sky-500'>Register</span></p>
