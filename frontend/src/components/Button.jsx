...
function Button({
  ...
  //  console.log(rest.className);
    const classes = twMerge(
        className('flex items-center px-3 py-2 border my-4 mx-1 focus:ring-2 focust:ring-cyan-900 focus:outline-none', {
          'border-cyan-500 bg-blue-500 text-white hover:bg-cyan-600 ...': primary,
          ...
          'text-cyan-500 hover:text-white ...': outline && primary,
